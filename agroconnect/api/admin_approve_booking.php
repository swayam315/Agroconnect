...
try {
    ...
    // --- 1. Get Booking Details (and verify it belongs to this hub) ---
    ...
    if ($stmt_update->rowCount() == 0) {
        throw new Exception('Booking could not be approved. It may no longer be pending.');
    }
    
    // --- 3. Create Notification for the Farmer ---
    create_notification(
        $pdo,
        $booking['renter_id'], // The ID of the farmer who made the booking
        'booking_approved',
